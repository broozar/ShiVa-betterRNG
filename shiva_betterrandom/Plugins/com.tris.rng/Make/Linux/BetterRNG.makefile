...
INCLUDES			= -I"$(SRCROOT)" -I$(SRCROOT)/Platforms/Linux -I../../Sources/S3DX -I../../Frameworks/Linux/include
CFLAGS_Common		= -Os -Wno-unknown-pragmas -fsigned-char -fno-exceptions -DS3DX_DLL -D__LINUX__ -D_GNU_SOURCE -DHAVE_STDINT_H -DS3DX_DLL -D__LINUX__ -D_GNU_SOURCE -DHAVE_STDINT_H
